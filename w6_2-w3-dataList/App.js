...
import TravelDomesticDetail from './src/screens/TravelDomesticDetail'
import TravelForeignDetail from './src/screens/TravelForeignDetail'
...
function TravelStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="TravelDomesticScreen" component={TravelDomesticStack} options={{ title: '國內旅行' }} />
      <Stack.Screen name="TravelForeignScreen" component={TravelForeignStack} options={{ title: '國外旅行' }} />
    </Stack.Navigator>
  )
}

function TravelDomesticStack() {
  return (
    <Stack.Navigator
      screenOptions={{
        headerShown: false,
    ...
    >
      ...
      <Stack.Screen name="TravelDomesticDetail" component={TravelDomesticDetail} options={{ title: '國內旅行列表' }} />
    </Stack.Navigator>
  )
}

function TravelForeignStack() {
  return (
    <Stack.Navigator
      screenOptions={{
        headerShown: false,
    ...
    >
      ...
      <Stack.Screen name="TravelForeignDetail" component={TravelForeignDetail} options={{ title: '國外旅行列表' }} />
    </Stack.Navigator>
  )
}
